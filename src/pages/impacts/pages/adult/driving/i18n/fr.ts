  ...
  ss1: {
    ...
    classes: {
      ...
      class1To4: {
        ...
        bullets: [
          `L’épilepsie est essentiellement incompatible avec la conduite d’un véhicule lourd articulé, d’un autobus, d’un taxi, d’un véhicule d’urgence`,
          `Maintenant, le patient sans crise depuis plus de 5 ans a accès aux classes 1-4 au Canada seulement (depuis janvier 2010)`
        ],
        exceptions: {
          title: `Exceptions pour les classes 1-4:`,
          bullets: [
            `Crises focales sans altération de la conscience et sans impact sur la conduite sécuritaire d’un véhicule (délai de 3 ans du début)`,
            `Crises secondaires à l’arrêt ou modification de la médication par le médecin, et qu’il y avait plus de 5 ans sans crises auparavant (délai de 6 mois avec la reprise du traitement)`,
            `Crises groupées sur une période courte dans contexte de maladie intercurrente (délai de 6 mois sans crise)`
          ]
        }
      }
    }
